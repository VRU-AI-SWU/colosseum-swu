...
| รายงาน + การอธิบายวิธีการ | 25% | ประเมินการเลือกอัลกอริทึม, reward design, ablation, การวิเคราะห์ความล้มเหลว — **rubric ของ Comp 1 อยู่ที่ [vacuum-robot §12.5](vacuum-robot/overview.md#125-คำถามที่รายงานต้องตอบ)** |
...
> **ส่วนนี้แบกน้ำหนักมากขึ้นหลังผลการ calibrate ของ Competition 1**
> เมื่อวัดแล้วพบว่า BFS planner ชนะ RL ในโจทย์หุ่นดูดฝุ่นโดยธรรมชาติ
> ([เหตุผลเชิงทฤษฎี](vacuum-robot/overview.md#12-ทำไม-planning-ถึงเหมาะกับโจทย์นี้--สิ่งที่นิสิตต้องอธิบายได้))
> leaderboard จึงไม่ใช่ตัววัดว่า "ใช้ทฤษฎีเป็นไหม" อีกต่อไป — **รายงานเป็นตัววัดนั้นแทน**
>
> รูปแบบที่ใช้: บังคับส่ง **ทั้ง planner และ learned policy** แล้ววิเคราะห์ว่าอันไหนชนะที่ระดับความยากไหน
> ซึ่งเป็นการทดลองเดียวกับที่ผู้สอนทำ และเครื่องมือพร้อมแล้วใน starter kit
