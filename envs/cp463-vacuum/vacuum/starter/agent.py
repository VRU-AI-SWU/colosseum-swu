...
class Agent:
    ...
    def reset(self, episode_info: dict) -> None:
        ...
        ระบบตรวจข้อนี้ด้วยการรัน episode เดียวกันทั้งแบบต่อกันและแบบแยกกระบวนการ
        ถ้าคะแนนไม่ตรงกัน submission จะถูกปฏิเสธ
        """
        self.rng = np.random.Generator(np.random.PCG64(0))
    ...
    def act(self, observation) -> int:
        ...
        `observation` เป็น dict สามคีย์
            ...
            grid     ในโหมด local: float32 (3, k, k) — หน้าต่างรอบตัว
